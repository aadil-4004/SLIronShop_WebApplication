...
function ItemTiles({ image, name, icode, price, description, categoryName, onClick }) {
  return (
      ...
      <div className="min-w-[245px] max-w-[230px] max-h-[290px] min-h-[290px] rounded-xl bg-white flex flex-col px-1 mb-5 hover:border-[3px] hover:border-black-600">
        ...
        <div className="px-3 mt-1 mb-5">
          ...
          <h1 className="text-[#929292] text-[10px]">Item ID: {icode}</h1>
          <h1 className="text-[#929292] text-[10px]">Category: {categoryName}</h1>
