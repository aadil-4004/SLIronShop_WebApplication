          ...
          <div>
            ...
            <div className={`flex flex-col ${expanded ? 'items-start' : 'items-center'} `}>
                ...
                <div className='mb-5'>
                  ...
                  <div className={`flex p-3 ${activeLink === "billing" ? 'bg-[#FFEEEF]' : 'hover:bg-[#FFEEEF]'} rounded-lg ${expanded ? 'w-[155px]' : 'w-[50px] border-[1px] border-transparent'} ${expanded && activeLink !== "billing" ? 'border-[1px] border-gray-200' : ''} transition-all duration-500 ease-in-out`}>
                  <img src={billicon} alt="Billing" />
                  <span className={`flex-grow text-center transition-opacity ${expanded ? 'duration-[400ms] opacity-100 max-w-full' : 'duration-0 opacity-0 max-w-0'}`}>Billing</span>
                  </div>
                  </a>
                </div>
                ...
                <div className='mb-5'>
                  ...
                  <img src={settingsicon_n} alt="Settings" c />
